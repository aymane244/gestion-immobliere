...
/**
 * Servlet implementation class SupprimerAchatProgramme
 */
@WebServlet("/SupprimerAchatProgramme")
public class SupprimerAchatProgramme extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SupprimerAchatProgramme() {
        super();
