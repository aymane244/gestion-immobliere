...
/**
 * Servlet implementation class ModifierClientAgent
 */
@MultipartConfig
@WebServlet("/ModifierClientAgent")
public class ModifierClientAgent extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ModifierClientAgent() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(image == "") {
			...
			session.setAttribute("success_clt_mod","Profile modifier avec succès");
			...
			if(!imageExtension.equals("png") && !imageExtension.equals("jpg") && !imageExtension.equals("jpeg")) {
				...
				response.sendRedirect("agent/modifier-profile-client.jsp");
			}else {
