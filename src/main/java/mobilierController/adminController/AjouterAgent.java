...
/**
 * Servlet implementation class AjouterAgent
 */
@MultipartConfig
@WebServlet("/AjouterAgent")
public class AjouterAgent extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(agentCheckEmail != null) {
			...
			response.sendRedirect("admin/ajouter-agent.jsp"); 
			...
			if(image == "") {
				...
				session.setAttribute("success_agt","Agent ajouter avec succès");
			}else {
