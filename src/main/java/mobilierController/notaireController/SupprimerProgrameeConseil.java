...
/**
 * Servlet implementation class SupprimerProgrameeConseil
 */
@WebServlet("/SupprimerProgrameeConseil")
public class SupprimerProgrameeConseil extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SupprimerProgrameeConseil() {
        super();
