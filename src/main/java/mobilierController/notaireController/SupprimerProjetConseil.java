...
/**
 * Servlet implementation class SupprimerProjetConseil
 */
@WebServlet("/SupprimerProjetConseil")
public class SupprimerProjetConseil extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SupprimerProjetConseil() {
        super();
