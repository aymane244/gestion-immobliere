...
/**
 * Servlet implementation class PromoteurInscription
 */
@MultipartConfig
@WebServlet("/PromoteurInscription")
public class PromoteurInscription extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public PromoteurInscription() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(promoteurCheckEmail != null) {
			...
			response.sendRedirect("promoteur/inscription.jsp");
			...
			if(image == "") {
				...
				session.setAttribute("success_pro","Inscription réussite");
			}else {
