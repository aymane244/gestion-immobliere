	...
	<div class="container my-5 pb-4">
    	...
    	<div class="row justify-content-center">
        	<div class="col-md-8">
				...
				%>
				<%
        			if(session.getAttribute("fail_log") != null){
        		%>
        		<div class='container alert alert-danger text-center w-50' role='alert'>
					<%= session.getAttribute("fail_log")%>
				</div>
				<%
        			}
				%>
				...
				%>
				<%
        			if(session.getAttribute("msgdec") != null){
        		%>
        		<div class='container alert alert-success text-center w-50' role='alert'>
					<%= session.getAttribute("msgdec")%>
				</div>
				<%
        			}
				%>
				<%
        			if(session.getAttribute("success_pwd") != null){
        		%>
        		<div class='container alert alert-success text-center w-50' role='alert'>
					<%= session.getAttribute("success_pwd")%>
				</div>
				<%
        			}
				%>
                    	...
                    	<form action="<%= request.getContextPath() %>/AdminLogin" method="post">
                        	<div class="row mb-3">
                            	...
                            	<div class="col-md-6">
                                	<div class="d-flex">
                                    	...
                                    	<input id="email" type="email" class="form-control pl-5" name="email" autocomplete="email" autofocus placeholder="Votre email" required>
                                	</div>
                            	</div>
                        	</div>
                        	<div class="row mb-3">
                        	...
                        	<div class="row mb-0">
                            	<div class="col-md-8 offset-md-4">
                                	...
                                	<a href="admin/inscription.jsp" class="px-4">S'inscrire Ici</a>
                            	</div>
                        	</div>
                        	<div class="row text-center mt-3">
                            	<div class="col-md-12">
                                	<a href='admin/motdepasse.jsp' target="blank">Mot de passe oublié</a>
                                </div>
                        	</div>
                    	</form>
                	</div>
