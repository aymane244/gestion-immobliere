...
<%
	...
	Promoteur pros = db.selectPromoteur(id);
%>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="ISO-8859-1">
		<title>Modifier Promoteur</title>
            ...
            <div class="row justify-content-center">
                <div class="col-md-10 mt-5">
                    ...
                    <div class="card card-position">
                    	<div class="card-header text-center link-font"><i class="fas fa-edit"></i> Modifier Promoteur</div>
                        <div class="card-body py-5">
                            <div class="text-center mb-3">
                                ...
                                <%
                                    if(pros.getImage() == null){
                                %>
                                <img src="../images/unknown_person.jpg"  class='rounded-circle img-fluid' style='max-width: 5rem' id='image_display'>
                                <%
									}else{
								%>
								<img src="../images/promoteur/<%=pros.getImage()%>" class='rounded-circle img-fluid' style='max-width: 5rem' id='image_display'>
								<%	
									}
								%>
                            </div>
                            <form action="<%= request.getContextPath() %>/ModifierPromoteur" method="post" enctype="multipart/form-data">
                            	<div class="row mb-3">
                            		<div class="col-md-6">
                                		<label for="nom" class="col-md-12 col-form-label text-md-end">Nom</label>
                                    	<div class="d-flex">
                            	        	<i class="fas fa-user position-awesome"></i>
                                        	<input id="nom" type="text" class="form-control pl-5" name="nom" autocomplete="nom" value="<%= pros.getNom() %>" placeholder="Votre nom" required>
                                    	</div>
                   	            	</div>
                                    <div class="col-md-6">
                                        ...
                                        <div class="d-flex">
                                            <i class="fas fa-user position-awesome"></i>
                                            <input id="prenom" type="text" class="form-control pl-5" name="prenom" autocomplete="prenom" value="<%= pros.getPrenom() %>" placeholder="Votre prénom" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <input id="cin" type="text" class="form-control pl-5" name="cin" autocomplete="cin" value="<%= pros.getCin() %>" placeholder="Votre carte d'identité nationale">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <input id="phone" type="text" class="form-control pl-5" name="phone" autocomplete="phone" value="<%= pros.getTelephone() %>" placeholder="Votre numéro de téléphone" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <input id="email" type="email" class="form-control pl-5" name="email" autocomplete="email" value="<%=pros.getEmail() %>" placeholder="Votre numéro de téléphone" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                ...
                                <input type="hidden" value="<%= pros.getId() %>" name="id">
                                <div class="row mb-0">
