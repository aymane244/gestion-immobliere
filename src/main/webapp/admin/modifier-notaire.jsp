...
<%
	...
	Notaire notaires = db.selectNotaire(id);
%>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="ISO-8859-1">
		<title>Modifier notaire</title>
            ...
            <div class="row justify-content-center">
                <div class="col-md-10 mt-5">
                    ...
                    <div class="card card-position">
                    	<div class="card-header text-center link-font"><i class="fas fa-edit"></i> Mofidier profile</div>
                        <div class="card-body py-5">
                            <div class="text-center mb-3">
                                ...
                                <%
                                    if(notaires.getImage() == null){
                                %>
                                <img src="../images/unknown_person.jpg"  class='rounded-circle img-fluid' style='max-width: 5rem' id='image_display'>
                                <%
									}else{
								%>
								<img src="../images/promoteur/<%=notaires.getImage()%>" class='rounded-circle img-fluid' style='max-width: 5rem' id='image_display'>
								<%	
									}
								%>
                            </div>
                            <form action="<%= request.getContextPath() %>/ModifierNotaire" method="post" enctype="multipart/form-data">
                            	<div class="row mb-3">
                            		<div class="col-md-6">
                                		<label for="nom" class="col-md-12 col-form-label text-md-end">Nom</label>
                                    	<div class="d-flex">
                            	        	<i class="fas fa-user position-awesome"></i>
                                        	<input id="nom" type="text" class="form-control pl-5" name="nom" autocomplete="nom" value="<%= notaires.getNom() %>" placeholder="Votre nom" required>
                                    	</div>
                   	            	</div>
                                    <div class="col-md-6">
                                        ...
                                        <div class="d-flex">
                                            <i class="fas fa-user position-awesome"></i>
                                            <input id="prenom" type="text" class="form-control pl-5" name="prenom" autocomplete="prenom" value="<%= notaires.getPrenom() %>" placeholder="Votre prénom" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <input id="cin" type="text" class="form-control pl-5" name="cin" autocomplete="cin" value="<%= notaires.getCin() %>" placeholder="Votre carte d'identité nationale">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <input id="phone" type="text" class="form-control pl-5" name="phone" autocomplete="phone" value="<%= notaires.getTelephone() %>" placeholder="Votre numéro de téléphone" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <input id="email" type="email" class="form-control pl-5" name="email" autocomplete="email" value="<%=notaires.getEmail() %>" placeholder="Votre numéro de téléphone" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                ...
                                <input type="hidden" value="<%= notaires.getId() %>" name="id">
                                <div class="row mb-0">
