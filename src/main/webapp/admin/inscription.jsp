			...
			<div class="row">
				<div class="col-lg-12 col-md-12">
					<div class="card">
                        ...
                        <%
        					if(session.getAttribute("fail_insc") != null){
        				%>
        				<div class='container alert alert-danger text-center w-50' role='alert'>
							<%= session.getAttribute("fail_insc")%>
						</div>
						<%
        					}
						%>
                        <div class="card-body py-5">
                        	<form action="<%= request.getContextPath() %>/AdminInscription" method="post" enctype="multipart/form-data">
                        		<div class="row">
                        			<div class="col-lg-4">
                                        <div class="row mb-3">
