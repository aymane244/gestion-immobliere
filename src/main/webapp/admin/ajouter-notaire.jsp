		...
		<div class="container my-5 pt-5 pb-5">
			<div class="row">
				<div class="col-lg-12 col-md-12">
					<%
        				if(session.getAttribute("fail_not") != null){
       				%>
       				<div class='container alert alert-danger text-center w-50' role='alert'>
						<%= session.getAttribute("fail_not")%>
					</div>
					<%
        				}
					%>
					<div class="card">
						<div class="card-header text-center link-font">
                            <h3><i class="fas fa-edit"></i> Ajouter Notaire</h3>
                        </div>
                        <div class="card-body py-5">
                        	<form action="<%= request.getContextPath() %>/AjouterNotaire" method="post" enctype="multipart/form-data">
                        		<div class="row">
                        		 	<div class="col-lg-4">
                                        <div class="row mb-3">
