				...
				<div class="col-lg-12 col-md-12">
					...
					<div class="card">
						<div class="card-header text-center link-font">
                            <h3><i class="fas fa-edit"></i> Ajouter Promoteur</h3>
                        </div>
                        <div class="card-body py-5">
                        	<form action="<%= request.getContextPath() %>/AjouterPromoteur" method="post" enctype="multipart/form-data">
                        		<div class="row">
                        			<div class="col-lg-4">
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-12">
                                                <div class="d-flex">
                                                    ...
                                                    <input id="nom" type="text" class="form-control pl-5" name="nom" autocomplete="nom" placeholder="Votre nom" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-12">
                                                <div class="d-flex">
                                                    <i class="fas fa-user position-awesome"></i>
                                                    <input id="prenom" type="text" class="form-control pl-5" name="prenom" autocomplete="prenom" placeholder="Votre prénom" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-12">
                                                <div class="d-flex">
                                                    ...
                                                    <input id="cin" type="text" class="form-control pl-5" name="cin" autocomplete="CIN" placeholder="Votre CIN" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                		...
                                		<div class="row mb-3">
                                            ...
                                            <div class="col-md-12">
                                               	<div class="d-flex">
                                                   	...
                                                   	<input id="phone" type="text" class="form-control pl-5" name="phone" autocomplete="phone" placeholder="Votre Numéro de téléphone" required>
                                               	</div>
                                           	</div>
                                       	</div>
                                    </div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-12">
                                                <div class="d-flex">
                                                    ...
                                                    <input id="email" type="email" class="form-control pl-5" name="email" autocomplete="email" placeholder="Votre email" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-12">
                                                <div class="d-flex">
                                                    ...
                                                    <input id="motdepasse" type="password" class="form-control pl-5" name="motdepasse" placeholder="Votre mot de passe" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
