...
<%
	...
	AchatProjet achat = dbBien.selectAchatProjet(id);
%>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="ISO-8859-1">
		<title>Conseil <%= achat.getProjetNom() %></title>
				...
				<div class="col-lg-12 col-md-12">
					<div class="card">
						<div class="card-header text-center link-font">
                            <h3><i class="fas fa-edit"></i> Demande de conseil sur le projet <%= achat.getProjetNom() %></h3>
                        </div>
                        <div class="card-body py-5">
                        	<form action="<%= request.getContextPath() %>/DemandeConseilProjet" method="post">
                        		<div class="row">
                                    <div class="col-lg-12">
                                        <div class="row mb-3">
                                ...
                                <div class="row mb-0 text-center mt-3">
                                    <div class="col-md-12">
                                    	...
                                    	<input type="hidden" value="<%= achat.getProjet() %>" id="projet" name="projet">
