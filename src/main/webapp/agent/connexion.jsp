...
<body>
	...
	<div class="container my-5 pb-4">
		<div class="mt-5 pt-5">
        	<h2 class="text-center">Espace agent</h2>
            <hr class="hr-style">
       	</div>
    	<div class="row justify-content-center">
        	<div class="col-md-8">
				...
				%>
                <%
        			if(session.getAttribute("success_agt_dec") != null){
       			%>
       			<div class='container alert alert-success text-center w-50' role='alert'>
					<%= session.getAttribute("success_agt_dec")%>
				</div>
				<%
        			}
				%>
                <%
        			if(session.getAttribute("success_agt_pwd") != null){
       			%>
       			<div class='container alert alert-success text-center w-50' role='alert'>
					<%= session.getAttribute("success_agt_pwd")%>
				</div>
				<%
        			}
				%>
               	<%
       				if(session.getAttribute("fail_agt") != null){
   				%>
       			<div class='container alert alert-danger text-center w-50' role='alert'>
					<%= session.getAttribute("fail_agt")%>
				</div>
				<%
       				}
				%>
            	<div class="card card-position">
                	...
                	<div class="card-body py-5">
                    	<form action="<%= request.getContextPath() %>/Agentlogin" method="post">
                        	<div class="row mb-3">
                            	<label for="cin" class="col-md-4 col-form-label text-md-end">Email</label>
                            	<div class="col-md-6">
                                	<div class="d-flex">
                        	...
                        	<div class="row mb-3">
                            	<label for="motdepasse" class="col-md-4 col-form-label text-md-end">Mot de passe</label>
                            	<div class="col-md-6">
                                	<div class="d-flex">
                                    	<i class="fas fa-key position-awesome"></i>
                                    	<input id="motdepasse" type="password" class="form-control pl-5" name="motdepasse" autocomplete="current-password" placeholder="Votre mot de passe" required>
                                	</div>
                            	</div>
                        	</div>
                        	<div class="row mb-0">
