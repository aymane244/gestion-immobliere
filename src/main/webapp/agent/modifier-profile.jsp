		...
		<div class="container my-5 pt-5 pb-5">
			<div class="row">
				<div class="col-lg-12 col-md-12">
					<%
        				if(session.getAttribute("fail_agt_profile") != null){
       				%>
       				<div class='container alert alert-danger text-center w-50' role='alert'>
						<%= session.getAttribute("fail_agt_profile")%>
					</div>
					<%
        				}
					%>
					<div class="card">
                        ...
                        <div class="card-body py-5">
                        	<div class="text-center mb-3">
								...
								%>
								<img src="../images/agent/<%=agent.getImage()%>" class='rounded-circle img-fluid' style='max-width: 5rem' id='image_display'>
								<%	
									}
								%>
                            </div>
                        	<form action="<%= request.getContextPath() %>/ModifierProfileAgent" method="post" enctype="multipart/form-data">
                        		<div class="row">
                        			<div class="col-lg-6">
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-12">
                                                <div class="d-flex">
                                                    ...
                                                    <input id="nom" type="text" class="form-control pl-5" name="nom" value="<%= agent.getNom() %>" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-12">
                                                <div class="d-flex">
                                                    <i class="fas fa-user position-awesome"></i>
                                                    <input id="prenom" type="text" class="form-control pl-5" name="prenom" value="<%= agent.getPrenom() %>" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-12">
                                                <div class="d-flex">
                                                    ...
                                                    <input id="cin" type="text" class="form-control pl-5" name="cin" value="<%= agent.getCin() %>" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-12">
                                                <div class="d-flex">
                                                    ...
                                                    <input id="email" type="email" class="form-control pl-5" name="email" value="<%= agent.getEmail() %>" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
