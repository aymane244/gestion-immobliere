...
<html>
	...
	<body>
		...
		<div class="container mt-5 pt-5">
			<%
        		if(session.getAttribute("fail_pro_mod_prog") != null){
       		%>
   			<div class='container alert alert-danger text-center w-50' role='alert'>
				<%= session.getAttribute("fail_pro_mod_prog")%>
			</div>
			<%
       			}
			%>
			<div class="text-center py-3">
            	<h2><i class="fas fa-plus-square"></i> Modifier un programme</h2>
          	</div>
          	<form action="<%= request.getContextPath() %>/ModifierProgramme" method="POST" enctype="multipart/form-data">
          		<input type="hidden" value="<%= programme.getId() %>" name="id">
             	<div class="row">
                	<div class="col-md-12 my-5">
                    	<div class="card card-position">
                        	<div class="card-header text-center link-font align-items-center">
                            	<i class="fas fa-plus-square"></i> Modifier un programme
                           	</div>
                           	<div class="card-body py-5 w-100">
                            	<div class="row mb-3">
                                	<label for="titre" class="col-md-12 col-form-label text-md-end">Nom du programme</label>
                                  	<div class="col-md-12">
                              	    	<div class="d-flex">
                                            ...
                                            <input id="titre" type="text" class="form-control pl-5" name="titre" value="<%= programme.getNomProgramme() %>">
          	                           </div>
           	                     	</div>
                                 </div>
                                 <div class="row mb-3">
                                 	<div class="col-md-4">
         	                         	...
         	                         	<div class="col-md-12">
            	                  	    	<div class="d-flex">
                	           	            	<i class="fas fa-tag position-awesome"></i>
                    	                        <input id="nom" type="text" class="form-control pl-5" name="nom" value="<%= programme.getNom() %>">
          	            	               </div>
           	                	     	</div>
                                 	</div>
                                 	<div class="col-md-4">
         	                         	...
         	                         	<div class="col-md-12">
            	                  	    	<div class="d-flex">
                	           	            	<i class="fas fa-tag position-awesome"></i>
                    	                        <input id="prix" type="number" min="10000"  step="1000" class="form-control pl-5" name="prix" value="<%= programme.getPrix() %>">
          	            	               </div>
           	                	     	</div>
                                 	</div>
                                 	<div class="col-md-4">
         	                         	...
         	                         	<div class="col-md-12">
            	                  	    	<div class="d-flex">
                	           	            	<i class="fas fa-tag position-awesome"></i>
                    	                        <input id="prix_metre" type="number" min="3000" step="100" class="form-control pl-5" name="prix_metre" value="<%= programme.getPrixMetre() %>">
          	            	               </div>
           	                	     	</div>
                                 	</div>
                                 	<div class="col-md-4">
         	                         	...
         	                         	<div class="col-md-12">
            	                  	    	<div class="d-flex">
                	           	            	<i class="fas fa-tag position-awesome"></i>
                    	                        <input id="chambre" type="number" min="3" max="10" class="form-control pl-5" name="chambre" value="<%= programme.getChambre() %>">
          	            	               </div>
           	                	     	</div>
                                 	</div>
                                 	<div class="col-md-4">
         	                         	...
         	                         	<div class="col-md-12">
            	                  	    	<div class="d-flex">
												...
												<select class="custom-select px-5" name="type">
													<option value="<%= programme.getType() %>"><%= programme.getType() %></option>
                                 	...
                                 	<div class="col-md-4">
         	                         	...
         	                         	<div class="col-md-12">
            	                  	    	<div class="d-flex">
                    	                        ...
                    	                        <input id="date" type="date" class="form-control pl-5" name="date" value="<%= programme.getDate() %>">
          	            	               </div>
           	                	     	</div>
                                 	</div>
                                 	<div class="col-md-4">
         	                         	...
         	                         	<div class="col-md-12">
            	                  	    	<div class="d-flex">
												...
												<select class="custom-select px-5" name="etat">
													<option value="<%= programme.getEtat() %>"><%= programme.getEtat() %></option>
                                 	...
                                 	<div class="col-md-6">
         	                         	...
         	                         	<div class="col-md-12">
            	                  	    	<div class="d-flex">
                	           	            	<i class="fas fa-tag position-awesome"></i>
                    	                        <input id="unite" type="number" min="100" max="1000" step="10" class="form-control pl-5" name="unite"  value="<%= programme.getUnite() %>">
          	            	               </div>
           	                	     	</div>
                                 	</div>
                                 	<div class="col-md-6">
         	                         	...
         	                         	<div class="col-md-12">
            	                  	    	<div class="d-flex">
                	           	            	<i class="fas fa-tag position-awesome"></i>
                    	                        <input id="ville" type="text" class="form-control pl-5" name="ville"  value="<%= programme.getVille() %>">
          	            	               </div>
           	                	     	</div>
                                 	</div>
                                 </div>
                                 <div class="row mb-3">
                                      ...
                                      <div class="col-md-12">
                    	                  <textarea id="editor"rows="10" class="form-control position-text-area" name="description" ><%= programme.getDescription() %></textarea>
                                      </div>
                 	              </div>
                                   ...
                                   <label for="prof" class="col-md-12 col-form-label text-md-end">Image</label>
                                    ...
                                    <div class="col-md-6">
                                    	<img src="../images/promoteur/assets/<%= programme.getImage() %>" style="max-width:20rem">
                        	            <div id="display_image" class="display_image" style="background-size:100% 100%; background-repeat:no-repeat"></div>
                  	                </div>
                                </div>
                               	<div class="row mb-0 text-center">
                                  	<div class="col-md-12">
                                      	<button type="submit" name="submit" class="btn btn-primary">Modifier le programme</button>
                                    </div>
                  	        	</div>
                          	</div>
                       	</div>
