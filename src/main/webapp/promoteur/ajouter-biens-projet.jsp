...
<%@page import="mobilierModel.Projet"%>
...
<%
	...
	List<Projet> projets = db.selectAllProjet();
%>
<!DOCTYPE html>
<html>
	<head>
...
<body>
	...
	<div class="container mt-5 pt-5">
		...
		%>
		<form action="<%= request.getContextPath() %>/AjouterBienProjet" method="POST">
        	<div class="row">
                 			...
                 			<div class="row mb-3">
                            	...
                            	<div class="col-md-4">
         	                		...
         	                		<div class="col-md-12">
            	           				<div class="d-flex">
                		   					<i class="fas fa-tag position-awesome"></i>
                                			<input id="prix_metre" type="number" min="3000" step="100" class="form-control pl-5" name="prix_metre">
          	           	   				</div>
           	               			</div>
                   				</div>
          	                	<div class="col-md-4">
