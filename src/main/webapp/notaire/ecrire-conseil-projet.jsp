...
<html>
	<head>
		...
		<title>Ecrire conseil sur le bien <%= conseil.getProjetNom() %></title>
				...
				<div class="col-lg-12 col-md-12">
					<div class="card">
						<div class="card-header text-center link-font">
                            <h3><i class="fas fa-edit"></i> Ecrire conseil sur le bien <%= conseil.getProjetNom() %></h3>
                        </div>
                        <div class="card-body py-5">
                        	<form action="<%= request.getContextPath() %>/AjouterConseilProjet" method="post">
                        		<div class="row">
                        		 	<div class="col-lg-12">
                                        <div class="row mb-3">
