                            ...
                            <form action="<%= request.getContextPath() %>/NotaireModifierProfile" method="post" enctype="multipart/form-data">
                            	<div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="d-flex">
                                            <i class="fas fa-user position-awesome"></i>
                                            <input id="prenom" type="text" class="form-control pl-5" name="prenom" autocomplete="prenom" value="<%= notaire.getPrenom() %>" placeholder="Votre prénom" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <input id="cin" type="text" class="form-control pl-5" name="cin" autocomplete="cin" value="<%= notaire.getCin() %>" placeholder="Votre carte d'identité nationale">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <input id="phone" type="text" class="form-control pl-5" name="phone" autocomplete="phone" value="<%= notaire.getTelephone() %>" placeholder="Votre numéro de téléphone" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <input id="email" type="email" class="form-control pl-5" name="email" autocomplete="email" value="<%=notaire.getEmail() %>" placeholder="Votre numéro de téléphone" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
