...
<%
	...
	ConseilProgramme conseil = db.selectConseilProgramme(id);
%>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="ISO-8859-1">
		<title>Ecrire conseil sur le bien <%= conseil.getProgrammeNom() %></title>
				...
				<div class="col-lg-12 col-md-12">
					<div class="card">
						<div class="card-header text-center link-font">
                            <h3><i class="fas fa-edit"></i> Ecrire conseil sur le bien <%= conseil.getProgrammeNom() %></h3>
                        </div>
                        <div class="card-body py-5">
                        	<form action="<%= request.getContextPath() %>/AjouterConseilProgramme" method="post">
                        		<div class="row">
                        		 	<div class="col-lg-12">
                                        <div class="row mb-3">
